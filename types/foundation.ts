...
export type SchoolDirectoryStatus = 'active' | 'inactive' | 'graduated' | 'transferred' | 'left_school' | 'archived';
export type SchoolDirectoryPersonKind = 'student' | 'parent' | 'guardian' | 'teacher' | 'school_administrator' | 'transport_manager' | 'transport_coordinator' | 'gate_staff' | 'handoff_staff' | 'driver' | 'fleet_provider_contact' | 'emergency_contact' | 'other_authorized_school_role';
export type SchoolContactPhoneStatus = 'unverified' | 'verification_pending' | 'verified' | 'failed' | 'expired' | 'replaced' | 'disputed' | 'phone_unreachable' | 'phone_reassigned_suspected' | 'reverification_required' | 'account_recovery_required';
export type SchoolContactLinkStatus = 'unlinked' | 'link_pending' | 'linked_existing_account' | 'linked_new_account' | 'manual_review' | 'rejected';
export type SchoolContactVerificationMethod = 'phone_match' | 'email_match' | 'organization_membership' | 'school_admin_review' | 'guardian_confirmation' | 'identity_document_review' | 'other';
export type SchoolDirectoryAccessScope = 'child_transport_history' | 'active_journey' | 'pickup_confirmation' | 'driver_identity' | 'vehicle_identity' | 'delay_status' | 'interruption_status' | 'recovery_status' | 'arrival_status' | 'handoff_confirmation' | 'safety_alerts' | 'school_transport_admin';
export type SchoolContactDuplicateStatus = 'possible_duplicate' | 'confirmed_same_person' | 'separate_people' | 'manual_review';
export type SchoolInvitationStatus = 'draft' | 'pending' | 'accepted' | 'rejected' | 'expired' | 'cancelled' | 'linked_existing_account' | 'manual_review';
export type SchoolDirectoryAcknowledgementState = 'not_required' | 'pending' | 'acknowledged' | 'disputed' | 'manual_review';
export type SchoolImportSourceType = 'csv' | 'excel_xlsx' | 'sis_export' | 'manual';
export type SchoolImportRowStatus = 'valid' | 'invalid' | 'duplicate' | 'missing_required_field' | 'invalid_phone' | 'unresolved_guardian' | 'unresolved_student' | 'conflict' | 'manual_review';
export type SchoolImportJobStatus = 'uploading' | 'validating' | 'preview_ready' | 'approved' | 'applied' | 'cancelled' | 'failed';
export type ChildAbsenceReasonCategory = 'sick' | 'medical_appointment' | 'family_reason' | 'school_absence' | 'guardian_self_pickup' | 'travel' | 'emergency' | 'other';
export type ChildAbsenceTransportScope = 'morning_only' | 'return_only' | 'morning_and_return' | 'selected_occurrence' | 'selected_occurrences' | 'whole_day';
export type ChildAbsenceReportStatus = 'reported' | 'acknowledged' | 'school_confirmed' | 'school_disputed' | 'retracted' | 'superseded' | 'cancelled';
export type ChildAbsenceConfirmationState = 'guardian_reported' | 'school_confirmed' | 'school_disputed' | 'unknown';
export type ChildAbsenceTimingState = 'before_dispatch' | 'after_dispatch_offer' | 'after_assignment' | 'after_journey_start';
export type ChildAbsenceImpactState = 'suppress_occurrence' | 'revoke_offer' | 'stale_offer' | 'step6c_cancellation_review' | 'step6d_recovery_boundary';
export type ChildAbsencePolicyReference = { policyId?: string; schoolId?: string; campusId?: string; cutoffTime?: string; acknowledgementRequired?: boolean; acknowledgementState?: SchoolDirectoryAcknowledgementState; timingState?: ChildAbsenceTimingState; impactState?: ChildAbsenceImpactState; scheduleExceptionReferenceId?: string; supportCaseId?: string; auditEventId?: string; };
export type SchoolContactChangeRecord = { contactChangeId: string; accountId?: string; childId?: string; guardianAccountId?: string; organizationMembershipId?: string; previousContact?: SchoolDirectoryPhoneReference | { email?: string }; newContact?: SchoolDirectoryPhoneReference | { email?: string }; requestedByAccountId?: string; requestedAt: string; effectiveAt?: string; verificationStatus?: SchoolContactPhoneStatus; linkStatus?: SchoolContactLinkStatus; verificationMethod?: SchoolContactVerificationMethod; reason?: string; auditEventId?: string; };
export type SchoolContactProfile = { contactProfileId: string; accountId?: string; childId?: string; guardianAccountId?: string; organizationMembershipId?: string; schoolId?: string; campusId?: string; primaryPhone?: SchoolDirectoryPhoneReference; secondaryPhones?: SchoolDirectoryPhoneReference[]; email?: string; contactStatus?: SchoolContactPhoneStatus; linkStatus?: SchoolContactLinkStatus; verificationMethod?: SchoolContactVerificationMethod; source?: string; auditEventId?: string; };
export type ChildAbsenceNotificationScope = 'school_admin' | 'transport_manager' | 'authorized_class_staff' | 'driver_provider_operational' | 'guardian';
export type ChildAbsenceChangeState = 'original' | 'corrected' | 'retracted' | 'replaced';
export type SchoolDirectoryEntryDuplicateStatus = SchoolContactDuplicateStatus;
export type SchoolDirectoryEntryPermissionReference = { capability?: 'view_child_transport' | 'schedule_transport' | 'cancel_occurrence' | 'report_absence' | 'request_self_pickup' | 'authorize_handoff_person' | 'receive_safety_updates' | 'manage_payment' | 'edit_child_details'; roleReference?: OrganizationMembershipRole | PoleSafeRole; scope?: string; };
export type SchoolDirectoryPhoneReference = { rawEnteredValue?: string; normalizedE164?: string; countryCode?: string; maskedDisplay?: string; verificationStatus?: SchoolContactPhoneStatus; verifiedAt?: string; source?: 'manual' | 'import' | 'account_profile' | 'school_record'; primary?: boolean; secondary?: boolean; };
export type SchoolPersonReference = { accountId?: string; childId?: string; guardianHouseholdId?: string; organizationMembershipId?: string; childDependentId?: string; displayName?: string; phone?: SchoolDirectoryPhoneReference; email?: string; schoolId?: string; campusId?: string; classId?: string; groupId?: string; roleReference?: SchoolDirectoryEntryPermissionReference; invitationStatus?: SchoolInvitationStatus; verificationStatus?: SchoolContactPhoneStatus; duplicateStatus?: SchoolDirectoryEntryDuplicateStatus; createdByAccountId?: string; createdAt?: string; source?: string; auditEventId?: string; };
export type SchoolStudentProfile = { childId: string; accountId?: string; schoolId?: string; campusId?: string; schoolStudentId?: string; classId?: string; groupId?: string; termReference?: string; currentTermReference?: string; historicalClassIds?: string[]; historicalGroupIds?: string[]; transportEnrollmentStatus?: 'active' | 'inactive' | 'pending' | 'suspended'; directoryStatus?: SchoolDirectoryStatus; auditEventId?: string; };
export type SchoolGuardianLink = { childId: string; guardianAccountId?: string; guardianHouseholdId?: string; authorizationLevelReference?: SchoolDirectoryEntryPermissionReference; notificationPreferenceReference?: string; pickupAuthorityReference?: string; handoffAuthorityReference?: string; transportChangeAuthorityReference?: string; absenceAuthorityReference?: string; scheduleAuthorityReference?: string; paymentAuthorityReference?: string; safetyNotificationAuthorityReference?: string; directoryAccessScopes?: SchoolDirectoryAccessScope[]; verificationStatus?: SchoolContactPhoneStatus; duplicateStatus?: SchoolDirectoryEntryDuplicateStatus; createdAt?: string; updatedAt?: string; auditEventId?: string; };
export type SchoolStaffProfile = { accountId?: string; organizationMembershipId?: string; schoolId?: string; campusId?: string; roleTitle?: string; assignedClassId?: string; assignedGroupId?: string; termReference?: string; historicalClassIds?: string[]; historicalGroupIds?: string[]; transportResponsibility?: boolean; handoffResponsibility?: boolean; status?: SchoolDirectoryStatus; invitationStatus?: SchoolInvitationStatus; verificationStatus?: SchoolContactPhoneStatus; auditEventId?: string; };
export type SchoolTransportStaffProfile = { accountId?: string; organizationMembershipId?: string; schoolId?: string; campusId?: string; routeId?: string; groupId?: string; termReference?: string; roleTitle?: 'transport_manager' | 'transport_coordinator' | 'gate_staff' | 'handoff_staff' | 'school_driver' | 'fleet_provider_liaison' | 'other'; transportResponsibility?: boolean; handoffResponsibility?: boolean; status?: SchoolDirectoryStatus; invitationStatus?: SchoolInvitationStatus; verificationStatus?: SchoolContactPhoneStatus; auditEventId?: string; };
export type SchoolDirectoryEntry = { directoryEntryId: string; schoolId?: string; campusId?: string; entryKind: SchoolDirectoryPersonKind; accountId?: string; childId?: string; guardianAccountId?: string; organizationMembershipId?: string; personReference?: SchoolPersonReference; studentProfile?: SchoolStudentProfile; guardianLink?: SchoolGuardianLink; staffProfile?: SchoolStaffProfile; transportStaffProfile?: SchoolTransportStaffProfile; contactProfile?: SchoolContactProfile; phone?: SchoolDirectoryPhoneReference; duplicateStatus?: SchoolDirectoryEntryDuplicateStatus; permissionReference?: SchoolDirectoryEntryPermissionReference; directoryStatus?: SchoolDirectoryStatus; source?: string; invitedByAccountId?: string; createdByAccountId?: string; createdAt: string; updatedAt?: string; auditEventId?: string; };
export type SchoolDirectory = { directoryId: string; schoolId: string; campusId?: string; organizationId?: string; status?: SchoolDirectoryStatus; entries?: SchoolDirectoryEntry[]; createdAt: string; updatedAt?: string; auditEventId?: string; };
export type SchoolInvitation = { invitationId: string; schoolId: string; campusId?: string; targetPhone?: SchoolDirectoryPhoneReference; targetEmail?: string; intendedRole?: SchoolDirectoryPersonKind; intendedRelationship?: string; linkedChildIds?: string[]; invitedByAccountId?: string; invitedAt: string; expiresAt?: string; status: SchoolInvitationStatus; acceptedAt?: string; resultingAccountId?: string; resultingOrganizationMembershipId?: string; linkStatus?: SchoolContactLinkStatus; auditEventId?: string; };
export type SchoolDirectoryImportRowResult = { rowNumber: number; status: SchoolImportRowStatus; duplicateStatus?: SchoolContactDuplicateStatus; childId?: string; guardianAccountId?: string; accountId?: string; studentReference?: string; notes?: string; auditEventId?: string; };
export type SchoolDirectoryImportJob = { importJobId: string; schoolId: string; campusId?: string; organizationId?: string; uploadedByAccountId?: string; sourceType: SchoolImportSourceType; sourceFileReferenceId?: string; status: SchoolImportJobStatus; rowCount?: number; validRowCount?: number; invalidRowCount?: number; duplicateRowCount?: number; conflictRowCount?: number; manualReviewRowCount?: number; appliedAt?: string; previewReadyAt?: string; validationResult?: string; auditEventId?: string; };
export type ChildAbsenceReport = { absenceReportId: string; childId: string; schoolId?: string; campusId?: string; reportDate: string; reportScope?: ChildAbsenceTransportScope; reasonCategory: ChildAbsenceReasonCategory; note?: string; reportedByAccountId?: string; reportedAt: string; status: ChildAbsenceReportStatus; timingState?: ChildAbsenceTimingState; impactState?: ChildAbsenceImpactState; confirmationState?: ChildAbsenceConfirmationState; policyReference?: ChildAbsencePolicyReference; occurrenceIds?: string[]; recurringScheduleReferenceId?: string; scheduleExceptionReferenceId?: string; notificationScope?: ChildAbsenceNotificationScope[]; effectiveOccurrenceIds?: string[]; linkedScheduleExceptionId?: string; linkedCancellationRequestId?: string; linkedDispatchOfferId?: string; linkedAssignmentId?: string; linkedJourneyId?: string; linkedNotificationEventIds?: string[]; linkedSupportCaseId?: string; linkedAuditEventId?: string; correctedByAbsenceReportId?: string; source?: string; };
export type ChildAbsenceCorrection = { correctionId: string; originalAbsenceReportId: string; childId: string; schoolId?: string; reportDate?: string; correctedByAccountId?: string; correctedAt: string; correctionType: 'retracted' | 'changed' | 'superseded'; reasonCategory?: ChildAbsenceReasonCategory; reportScope?: ChildAbsenceTransportScope; note?: string; beforeCutoff?: boolean; policyReference?: ChildAbsencePolicyReference; auditEventId?: string; };
...
export type ScheduleException = { id?: string; scheduleId: string; occurrenceId?: string; childId?: string; requestedByAccountId?: string; type: TransportPlanExceptionType; reason?: string; effectiveAt?: string; expiresAt?: string; approvalState?: ScheduleAcknowledgementState; resultingTransportStatus?: TransportPlanOccurrenceStatus; recurringScheduleReferenceId?: string; affectedOccurrenceIds?: string[]; policyReferenceId?: string; auditEventId?: string; };
...
export type JourneyLifecycleStatus = 'scheduled' | 'searching' | 'driver_assigned' | 'driver_en_route' | 'driver_arrived' | 'pickup_verification' | 'passenger_onboard' | 'in_trip' | 'delayed' | 'handoff_pending' | 'interrupted' | 'safe_stop' | 'recovery_pending' | 'recovery_planning' | 'recovery_in_progress' | 'recovery_completed' | 'recovery_blocked' | 'handoff_failed' | 'journey_complete' | 'completed' | 'cancelled' | 'emergency';
export type JourneyCheckpointType = 'assignment_confirmed' | 'driver_departed' | 'driver_arrived_pickup' | 'pickup_verified' | 'passenger_boarded' | 'route_checkpoint' | 'school_gate_arrival' | 'handoff_pending' | 'handoff_verified' | 'safe_stop' | 'interruption_reported' | 'recovery_requested' | 'recovery_planned' | 'recovery_attempted' | 'recovery_completed' | 'trip_completed';
...
export type JourneyChildState = 'not_boarded' | 'verified_for_boarding' | 'boarded' | 'onboard' | 'offboarded' | 'transferred' | 'handoff_pending' | 'handoff_failed' | 'safe_stop' | 'recovery_pending' | 'recovery_in_progress' | 'recovered' | 'completed' | 'cancelled';
export type JourneyPassengerState = 'not_boarded' | 'verified_for_boarding' | 'boarded' | 'onboard' | 'transferred' | 'handoff_pending' | 'handoff_failed' | 'safe_stop' | 'recovery_pending' | 'recovery_in_progress' | 'recovered' | 'completed' | 'cancelled';
export type JourneyInterruptionType = 'vehicle_breakdown' | 'driver_medical_emergency' | 'passenger_medical_emergency' | 'passenger_safety_interruption' | 'collision' | 'incident' | 'weak_connectivity' | 'guardian_unreachable' | 'school_unreachable' | 'handoff_failure' | 'unauthorized_receiver' | 'accessibility_issue' | 'route_blocked' | 'weather' | 'other';
export type SafeStopReason = 'vehicle_breakdown' | 'driver_medical_emergency' | 'passenger_medical_emergency' | 'collision' | 'incident' | 'handoff_failure' | 'unauthorized_receiver' | 'guardian_unreachable' | 'weak_connectivity' | 'safety_pause' | 'other';
export type RecoveryTriggerType = 'journey_interrupted' | 'passenger_onboard' | 'child_onboard' | 'handoff_failed' | 'safe_stop' | 'incident_linked' | 'collision_linked' | 'vehicle_breakdown' | 'medical_emergency' | 'guardian_unreachable' | 'weak_connectivity' | 'stale_recovery' | 'loop_protection';
export type RecoveryDecisionStatus = 'proposed' | 'approved' | 'rejected' | 'blocked' | 'superseded' | 'pending_acknowledgement';
export type RecoveryOutcomeStatus = 'planned' | 'in_progress' | 'succeeded' | 'failed' | 'blocked' | 'stale' | 'superseded' | 'handoff_pending' | 'handoff_failed';
export type RecoveryHandoffStatus = 'pending' | 'verified' | 'failed' | 'rejected' | 'expired' | 'handoff_pending';
export type JourneyRecoveryRequest = { recoveryRequestId: string; journeyId: string; bookingId?: string; assignmentId?: string; childId?: string; passengerIds?: string[]; triggerType: RecoveryTriggerType; interruptionId?: string; safeStopId?: string; incidentId?: string; supportCaseId?: string; safetyEvidenceId?: string; auditEventId?: string; notificationEventId?: string; requestedAt: string; requestedByAccountId?: string; requestedByRole?: PoleSafeRole; weakConnectivity?: boolean; journeyStatus?: JourneyLifecycleStatus; onboardState?: JourneyChildState | JourneyPassengerState; currentAssignmentId?: string; loopProtectionKey?: string; idempotencyKey?: string; concurrencyKey?: string; version?: number; revision?: string | number; staleVersion?: boolean; staleRecovery?: boolean; blockedReason?: string; guardianAcknowledgementReferenceIds?: string[]; schoolAcknowledgementReferenceIds?: string[]; multipleGuardianPrivacy?: boolean; returnTripIndependence?: boolean; multiStopCompatible?: boolean; accessibilityPreserved?: boolean; supports14Plus?: boolean; supportsMultiVehicleExtensibility?: boolean; partialTransferAllowed?: boolean; freshReplacementDriverRequired?: true; freshReplacementVehicleRequired?: true; replacementEligibilityReferenceId?: string; custodyContinuityRequired?: true; verifiedChildTransferRequired?: true; unauthorizedReceiverProtected?: true; failedHandoffAllowed?: true; handoffPendingAllowed?: true; replacementAssignmentId?: string; linkedRecoveryPlanId?: string; linkedRecoveryAttemptIds?: string[]; metadata?: Record<string, unknown>; };
export type JourneyRecoveryDecision = { recoveryDecisionId: string; recoveryRequestId: string; journeyId: string; bookingId?: string; assignmentId?: string; childId?: string; decisionStatus: RecoveryDecisionStatus; decidedAt: string; decidedByAccountId?: string; decidedByRole?: PoleSafeRole; activeJourneyBoundary?: boolean; custodyContinuityRequired?: true; freshReplacementDriverRequired?: true; freshReplacementVehicleRequired?: true; replacementEligibilityReferenceId?: string; staleVersion?: boolean; loopProtectionKey?: string; idempotencyKey?: string; concurrencyKey?: string; version?: number; revision?: string | number; guardianAcknowledgementReferenceIds?: string[]; schoolAcknowledgementReferenceIds?: string[]; supportCaseId?: string; incidentId?: string; safetyEvidenceId?: string; auditEventId?: string; notificationEventId?: string; metadata?: Record<string, unknown>; };
export type JourneyRecoveryPlan = { recoveryPlanId: string; recoveryRequestId: string; recoveryDecisionId?: string; journeyId: string; bookingId?: string; assignmentId?: string; childId?: string; planStatus: RecoveryPlanStatus; recoveryMode: CancellationRecoveryMode | 'safe_stop_recovery' | 'handoff_recovery' | 'medical_emergency_recovery' | 'breakdown_recovery'; createdAt: string; createdByAccountId?: string; recoveryTriggerType?: RecoveryTriggerType; safeStopId?: string; interruptionId?: string; incidentId?: string; supportCaseId?: string; safetyEvidenceId?: string; auditEventId?: string; notificationEventId?: string; custodyContinuityRequired?: true; freshReplacementDriverRequired?: true; freshReplacementVehicleRequired?: true; replacementEligibilityReferenceId?: string; freshReplacementDriverEligibilityId?: string; freshReplacementVehicleEligibilityId?: string; replacementAssignmentId?: string; linkedAssignmentId?: string; linkedRecoveryAttemptIds?: string[]; staleVersion?: boolean; loopProtectionKey?: string; idempotencyKey?: string; concurrencyKey?: string; version?: number; revision?: string | number; guardianAcknowledgementReferenceIds?: string[]; schoolAcknowledgementReferenceIds?: string[]; multipleGuardianPrivacy?: boolean; returnTripIndependence?: boolean; multiStopCompatible?: boolean; accessibilityPreserved?: boolean; supports14Plus?: boolean; supportsMultiVehicleExtensibility?: boolean; partialTransferAllowed?: boolean; verifiedChildTransferRequired?: true; unauthorizedReceiverProtected?: true; handoffPendingAllowed?: true; failedHandoffAllowed?: true; custodyTransferPlanReferenceId?: string; metadata?: Record<string, unknown>; };
export type JourneyRecoveryAttempt = { recoveryAttemptId: string; recoveryPlanId: string; recoveryRequestId?: string; recoveryDecisionId?: string; journeyId: string; bookingId?: string; assignmentId?: string; childId?: string; attemptStatus: RecoveryAttemptStatus; attemptedAt: string; attemptedByAccountId?: string; attemptedByRole?: PoleSafeRole; recoveryMode?: JourneyRecoveryPlan['recoveryMode']; triggerType?: RecoveryTriggerType; safeStopId?: string; interruptionId?: string; incidentId?: string; supportCaseId?: string; safetyEvidenceId?: string; recoveryOutcomeId?: string; handoffId?: string; handoffStatus?: RecoveryHandoffStatus; handoffPending?: boolean; custodyContinuityRequired?: true; freshReplacementDriverRequired?: true; freshReplacementVehicleRequired?: true; replacementEligibilityReferenceId?: string; replacementAssignmentId?: string; staleVersion?: boolean; loopProtectionKey?: string; idempotencyKey?: string; concurrencyKey?: string; version?: number; revision?: string | number; guardianAcknowledgementReferenceIds?: string[]; schoolAcknowledgementReferenceIds?: string[]; notificationEventId?: string; auditEventId?: string; metadata?: Record<string, unknown>; };
export type JourneyRecoveryOutcome = { recoveryOutcomeId: string; recoveryAttemptId: string; recoveryPlanId: string; recoveryRequestId?: string; journeyId: string; bookingId?: string; assignmentId?: string; childId?: string; outcomeStatus: RecoveryOutcomeStatus; decidedAt: string; decidedByAccountId?: string; decidedByRole?: PoleSafeRole; handoffId?: string; handoffStatus?: RecoveryHandoffStatus; handoffPending?: boolean; custodyContinuityRequired?: true; freshReplacementDriverRequired?: true; freshReplacementVehicleRequired?: true; replacementEligibilityReferenceId?: string; replacementAssignmentId?: string; verifiedChildTransferRequired?: true; unauthorizedReceiverProtected?: true; failedHandoffAllowed?: true; loopProtectionKey?: string; staleVersion?: boolean; idempotencyKey?: string; concurrencyKey?: string; version?: number; revision?: string | number; guardianAcknowledgementReferenceIds?: string[]; schoolAcknowledgementReferenceIds?: string[]; supportCaseId?: string; incidentId?: string; safetyEvidenceId?: string; notificationEventId?: string; auditEventId?: string; metadata?: Record<string, unknown>; };
export type RecoveryHandoff = { handoffId: string; recoveryRequestId?: string; recoveryDecisionId?: string; recoveryPlanId?: string; recoveryAttemptId?: string; recoveryOutcomeId?: string; journeyId: string; bookingId?: string; assignmentId?: string; childId?: string; status: RecoveryHandoffStatus; custodyContinuityRequired?: true; verifiedChildTransferRequired?: true; unauthorizedReceiverProtected?: true; receiverAccountId?: string; receiverRole?: PoleSafeRole; receiverDriverId?: string; receiverVehicleId?: string; receiverAssignmentId?: string; replacementAssignmentId?: string; handoffPending?: boolean; verifiedAt?: string; failedAt?: string; failureReason?: string; guardianAcknowledgementReferenceIds?: string[]; schoolAcknowledgementReferenceIds?: string[]; supportCaseId?: string; incidentId?: string; safetyEvidenceId?: string; notificationEventId?: string; auditEventId?: string; idempotencyKey?: string; concurrencyKey?: string; loopProtectionKey?: string; staleVersion?: boolean; version?: number; revision?: string | number; metadata?: Record<string, unknown>; };
export type JourneyInterruption = { interruptionId: string; journeyId: string; bookingId?: string; assignmentId?: string; childId?: string; interruptionType: JourneyInterruptionType; reason?: string; happenedAt: string; reportedByAccountId?: string; reportedByRole?: PoleSafeRole; safeStopId?: string; incidentId?: string; collisionIncidentId?: string; supportCaseId?: string; safetyEvidenceId?: string; recoveryRequestId?: string; recoveryDecisionId?: string; recoveryPlanId?: string; recoveryAttemptId?: string; recoveryOutcomeId?: string; handoffId?: string; handoffStatus?: RecoveryHandoffStatus; handoffPending?: boolean; weakConnectivity?: boolean; vehicleBreakdownAfterPickup?: boolean; driverMedicalEmergency?: boolean; passengerMedicalEmergency?: boolean; passengerSafetyInterruption?: boolean; childOnboard?: boolean; journeyActive?: boolean; custodyContinuityRequired?: true; freshReplacementDriverRequired?: true; freshReplacementVehicleRequired?: true; verifiedChildTransferRequired?: true; unauthorizedReceiverProtected?: true; guardianAcknowledgementReferenceIds?: string[]; schoolAcknowledgementReferenceIds?: string[]; multipleGuardianPrivacy?: boolean; returnTripIndependence?: boolean; multiStopCompatible?: boolean; accessibilityPreserved?: boolean; supports14Plus?: boolean; supportsMultiVehicleExtensibility?: boolean; partialTransferAllowed?: boolean; staleVersion?: boolean; loopProtectionKey?: string; idempotencyKey?: string; concurrencyKey?: string; version?: number; revision?: string | number; auditEventId?: string; notificationEventId?: string; metadata?: Record<string, unknown>; };
export type SafeStop = { safeStopId: string; journeyId: string; bookingId?: string; assignmentId?: string; childId?: string; reason: SafeStopReason; stoppedAt: string; stoppedByAccountId?: string; stoppedByRole?: PoleSafeRole; interruptionId?: string; incidentId?: string; collisionIncidentId?: string; supportCaseId?: string; safetyEvidenceId?: string; recoveryRequestId?: string; recoveryPlanId?: string; recoveryAttemptId?: string; recoveryOutcomeId?: string; handoffId?: string; handoffStatus?: RecoveryHandoffStatus; handoffPending?: boolean; custodyContinuityRequired?: true; freshReplacementDriverRequired?: true; freshReplacementVehicleRequired?: true; verifiedChildTransferRequired?: true; unauthorizedReceiverProtected?: true; weakConnectivity?: boolean; guardianAcknowledgementReferenceIds?: string[]; schoolAcknowledgementReferenceIds?: string[]; multipleGuardianPrivacy?: boolean; returnTripIndependence?: boolean; multiStopCompatible?: boolean; accessibilityPreserved?: boolean; supports14Plus?: boolean; supportsMultiVehicleExtensibility?: boolean; partialTransferAllowed?: boolean; staleVersion?: boolean; loopProtectionKey?: string; idempotencyKey?: string; concurrencyKey?: string; version?: number; revision?: string | number; auditEventId?: string; notificationEventId?: string; metadata?: Record<string, unknown>; };
export type Journey = { journeyId: string; bookingId?: string; assignmentId?: string; driverId?: string; vehicleId?: string; providerId?: string; status?: JourneyLifecycleStatus; startedAt?: string; driverArrivedAt?: string; pickupVerificationId?: string; passengerOnboardAt?: string; handoffVerificationId?: string; handoffPendingAt?: string; completedAt?: string; cancelledAt?: string; currentLocation?: { label?: string; latitude?: number; longitude?: number; visibility?: LocationVisibilityPolicy | ChildJourneyAccessScope; }; locationFreshness?: LocationFreshness; etaMinutes?: number; activeAlertReferences?: string[]; checkpointReferences?: string[]; interruptionReason?: string; interruptionId?: string; incidentIds?: string[]; childId?: string; childIds?: string[]; childJourneyStates?: Record<string, JourneyChildState>; passengerJourneyStates?: Record<string, JourneyPassengerState>; onboardChildIds?: string[]; onboardPassengerIds?: string[]; custodyContinuityRequired?: true; freshReplacementDriverRequired?: true; freshReplacementVehicleRequired?: true; verifiedChildTransferRequired?: true; unauthorizedReceiverProtected?: true; guardianVisibilityGrants?: JourneyVisibilityGrant[]; guardianAcknowledgementReferenceIds?: string[]; schoolAcknowledgementReferenceIds?: string[]; safetyEvidenceIds?: string[]; supportCaseIds?: string[]; notificationEventIds?: string[]; auditEventIds?: string[]; recoveryRequestId?: string; recoveryDecisionId?: string; recoveryPlanId?: string; recoveryAttemptIds?: string[]; recoveryOutcomeId?: string; handoffId?: string; handoffStatus?: RecoveryHandoffStatus; handoffPending?: boolean; safeStopId?: string; vehicleBreakdownAfterPickup?: boolean; driverMedicalEmergency?: boolean; passengerMedicalEmergency?: boolean; passengerSafetyInterruption?: boolean; weakConnectivity?: boolean; multipleGuardianPrivacy?: boolean; returnTripIndependence?: boolean; multiStopCompatible?: boolean; accessibilityPreserved?: boolean; supports14Plus?: boolean; supportsMultiVehicleExtensibility?: boolean; partialTransferAllowed?: boolean; loopProtectionKey?: string; staleVersion?: boolean; cancellationReferenceId?: string; createdAt: string; updatedAt?: string; };
