...
const TRANSLATIONS = {
  ...
  'safety_status_refreshing': { en: 'Checking latest safety status', lg: "Tukebedde embeera y\x27obukuumi egya leero" },
  'safety_check_refreshed': { en: 'Safety check refreshed', lg: 'Okukebera obukuumi kukyusiddwa' },
  'new_safety_check_required': { en: 'New safety check required', lg: 'Kyetaagisa okukebera obukuumi okupya' },
  'confirmation_pending': { en: 'Confirmation pending', lg: 'Okukakasa kukyali kujja' },
