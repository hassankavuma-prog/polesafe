      ...
      <div className="mx-auto flex max-w-7xl items-center gap-4 px-4 py-3 sm:px-6 lg:px-8">
        <Link href="/" className="flex items-center gap-3 rounded-2xl px-2 py-1.5 transition hover:bg-slate-50">
          ...
          <div>
            ...
            <div className="text-xs text-slate-500">Uganda-first mobility safety</div>
          </div>
        </Link>
        ...
        <div className="ml-auto flex items-center gap-2 sm:gap-3">
          ...
          <Link href="/ops" className="hidden rounded-full border border-slate-200 bg-white px-3 py-2 text-sm font-medium text-slate-600 transition hover:border-slate-300 hover:text-slate-900 sm:inline-flex">Dispatcher Ops Console</Link>
        </div>
      </div>
    ...
    <section className="border-b border-slate-200 bg-[linear-gradient(180deg,#08111f_0%,#0d1728_56%,#f8fafc_56%,#f8fafc_100%)]">
      <div className="mx-auto max-w-7xl px-4 pb-8 pt-10 sm:px-6 sm:pb-10 sm:pt-14 lg:px-8 lg:pb-12 lg:pt-16">
        <div className="grid items-center gap-10 lg:grid-cols-[1.05fr_0.95fr]">
          <div>
            <div className="inline-flex items-center rounded-full border border-sky-400/20 bg-sky-500/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.22em] text-sky-200">Public transportation safety platform</div>
          ...
          <div className="relative">
            ...
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-5 shadow-[0_24px_60px_rgba(8,15,32,0.35)] backdrop-blur-xl sm:p-6">
