        ...
        <div className="flex flex-col gap-3 py-3">
          <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:gap-6">
            ...
            <div className="flex shrink-0 flex-wrap items-center gap-2 rounded-2xl bg-white px-1 py-1 shadow-[0_1px_0_rgba(15,23,42,0.08),0_8px_24px_rgba(15,23,42,0.06)] ring-1 ring-slate-200/80 sm:gap-3 lg:justify-end">
              <Link href="/ops" className="whitespace-nowrap rounded-full border border-slate-300 bg-slate-50 px-3 py-2 text-sm font-medium text-slate-950 transition hover:border-slate-300 hover:text-black">Dispatcher Ops Console</Link>
