...
const INITIAL_TRANSACTIONS = [
  ...
  { transactionId: 'TXN-UG-98216', organizationId: 'ORG-KAMPALA-01', parentId: 'PAR-11293', amountUgx: 150000, paymentMethod: 'flutterwave_momo', status: 'failed', termReference: 'Term 1 2026', createdAt: '2026-03-02T11:00:00Z', confidence: 'offline-received', confidenceNote: 'Payment event recovered from queue replay', confidenceSource: 'queue_replay', paymentMatchStatus: 'failed', paymentProvider: 'mtn_momo' },
] as const;
